  ...
  return (
    <>
      <style>{`
        ...
        /* CHIC SCROLLBAR STYLING */
        .chic-scrollbar { scrollbar-width: thin; scrollbar-color: rgba(155, 155, 155, 0.5) transparent; }
        .chic-scrollbar::-webkit-scrollbar { width: 5px; }
        .chic-scrollbar::-webkit-scrollbar-track { background: transparent; margin: 4px 0; }
        .chic-scrollbar::-webkit-scrollbar-thumb { background-color: rgba(155, 155, 155, 0.3); border-radius: 20px; backdrop-filter: blur(5px); border: 1px solid transparent; background-clip: content-box; transition: background-color 0.3s ease; }
        .chic-scrollbar:hover::-webkit-scrollbar-thumb { background-color: rgba(155, 155, 155, 0.6); }
      `}</style>
      ...
      {isSettingsOpen && ( 
        <div className={`absolute top-20 right-6 z-[60] w-80 backdrop-blur-2xl border border-white/20 rounded-3xl p-6 shadow-[0_30px_60px_rgba(0,0,0,0.8)] animate-config-pop origin-top-right cursor-default transition-colors duration-300 ${isLightMode ? 'bg-white/80 text-black border-black/10' : 'bg-[#0a0a0a]/90 text-white border-white/10'}`} onPointerDown={stopProp}> 
            ...
            <div className="space-y-6 max-h-[60vh] overflow-y-auto pr-2 chic-scrollbar"> 
                {/* Physics Section */}
